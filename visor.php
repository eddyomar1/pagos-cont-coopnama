 ...
 * Versión administrador: Vista completa + Editar/Eliminar
 *************************************************/
session_start();
...
/* 5.0 Redirige index → full (comodidad admin) */
if ($action === 'index') { header('Location:?action=full'); exit; }

/* 5.2 Listado completo (todas las columnas necesarias) */
if ($action === 'full') {
    ...
    <form method="post" action="?action=<?=$editing?'update':'store'?>">
      ...
      <div class="row g-3">
        <div class="col-md-3">
          ...
          <input type="text" name="edif_apto" class="form-control" maxlength="60" value="<?=e($data['edif_apto'])?>" required>
        </div>
        <div class="col-md-5">
        ...
        <div class="col-md-2">
          ...
          <input type="text" name="codigo" class="form-control" maxlength="30" value="<?=e($data['codigo'])?>">
        </div>
        <div class="col-md-3">
          <label class="form-label">Teléfono</label>
          <input type="text" name="telefono" class="form-control" maxlength="50" value="<?=e($data['telefono'])?>">
        </div>
      </div>
